const Orders = () => {
  return (
    <div className="lg:col-start-1 col-span-6 lg:col-span-4 p-7 bg-white border border-[#EDF2F7] rounded-[0.875rem] h-[23.375rem] flex flex-col gap-5 overflow-auto scrollbar-hide">
      ...
      <div className="flex justify-between">
        <div className="flex items-start flex-col gap-6">
          ...
          <ul className="flex flex-col gap-7 text-base font-medium text-[#3A3F51] w-[10rem] md:w-auto">
        ...
        <div className="flex items-start flex-col gap-6">
          ...
          <ul className="flex flex-col gap-7 text-base font-normal text-[#737373] w-[8rem] md:w-auto">
            <li>Nov 15, 2023</li>
            <li>Nov 15, 2023</li>
            <li>Nov 14, 2023</li>
            <li>Nov 14, 2023</li>
        ...
        <div className="flex items-start flex-col gap-6">
          ...
          <ul className="flex flex-col gap-7 text-base font-medium text-[#0D062D] w-[7rem] md:w-auto">
            <li>$80,000</li>
            <li>$150,000</li>
            <li>$87,000</li>
            <li>$100,000</li>
        ...
        <div className="flex items-start flex-col gap-6">
          ...
          <ul className="flex flex-col gap-7 text-base font-normal w-[7rem] md:w-auto">
        ...
        <div className="flex items-start flex-col gap-6">
          ...
          <ul className="flex flex-col gap-7 text-sm/[1.375rem] font-normal w-[5rem] md:w-auto">
